...
; wPewterMuseumOfScience1FSceneID
  const_def 
  const SCENE_PEWTERMUSEUMOFSCIENCE1F_NOTHING ; 0
  const SCENE_PEWTERMUSEUMOFSCIENCE1F_SCENE   ; 1

; wRoute30SceneID
  const_def 
  const SCENE_ROUTE_30_NOTHING ; 0
  const SCENE_ROUTE_30_SCENE   ; 1
