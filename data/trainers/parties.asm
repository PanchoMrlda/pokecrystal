...
MortyGroup:
	...
	db 28, HAUNTER,    SPELL_TAG,    HYPNOSIS, MEAN_LOOK, NIGHTMARE, NIGHT_SHADE
	db 27, MISDREAVUS, TWISTEDSPOON, CONFUSE_RAY, MEAN_LOOK, SCREECH, PSYBEAM
	db 30, GENGAR,     BRIGHTPOWDER, HYPNOSIS, MEAN_LOOK, DREAM_EATER, SHADOW_BALL
	db -1 ; end
