...
BugsyGroup:
	...
	db 15, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 21, GASTLY,     NIGHT_SHADE, SPITE, MEAN_LOOK, CURSE
	db 20, ARIADOS,    POISON_STING, SCARY_FACE, LEECH_LIFE, NIGHT_SHADE
	db 20, MISDREAVUS, CONFUSE_RAY, MEAN_LOOK, SCREECH, PSYWAVE
	db 24, HAUNTER,    HYPNOSIS, MEAN_LOOK, NIGHTMARE, SHADOW_BALL
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 38, DELIBIRD,   GOLD_BERRY,   MUD_SLAP, ICY_WIND, FLY, TOXIC
	db 41, LAPRAS,     MIRACLEBERRY, HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 43, PILOSWINE,  LEFTOVERS,    EARTHQUAKE, ROCK_SLIDE, AMNESIA, BLIZZARD
	db -1 ; end
...
Rival1Group:
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 34, GOLBAT,     SCREECH, BITE, CONFUSE_RAY, WING_ATTACK
	db 32, MAGNETON,   SUPERSONIC, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 34, HAUNTER,    CONFUSE_RAY, MEAN_LOOK, CURSE, SHADOW_BALL
	db 36, SNEASEL,    ICE_PUNCH, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	...
	db 34, HAUNTER,    CONFUSE_RAY, MEAN_LOOK, CURSE, SHADOW_BALL
	db 36, SNEASEL,    ICE_PUNCH, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 36, TYPHLOSION, SMOKESCREEN, LEER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 34, HAUNTER,    CONFUSE_RAY, MEAN_LOOK, CURSE, SHADOW_BALL
	db 36, SNEASEL,    ICE_PUNCH, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 36, FERALIGATR, LEER, SURF, BITE, SCARY_FACE
	db -1 ; end
...
ScientistGroup:
	...
	db 37, PORYGON,    PSYBEAM, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end
...
SchoolboyGroup:
	...
	db 28, MR__MIME,   CONFUSION, DOUBLESLAP, LIGHT_SCREEN, REFLECT
	db 28, MAGNEMITE,  THUNDERSHOCK, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db -1 ; end

	; SCHOOLBOY (18)
	db "CHAD@", TRAINERTYPE_MOVES
	db 32, MR__MIME,   CONFUSION, DOUBLESLAP, LIGHT_SCREEN, REFLECT
	db 35, MAGNETON,   THUNDERSHOCK, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db -1 ; end
	...
	; SCHOOLBOY (23)
  db "CHAD@", TRAINERTYPE_MOVES
	db 37, MR__MIME,   PSYBEAM, FIRE_PUNCH, LIGHT_SCREEN, REFLECT
	db 38, TENTACRUEL, SUPERSONIC, ACID, BUBBLEBEAM, BARRIER
	db 41, MAGNETON,   THUNDERSHOCK, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db -1 ; end

	; SCHOOLBOY (24)
	db "CHAD@", TRAINERTYPE_MOVES
  db 41, MR__MIME,   PSYCHIC_M, FIRE_PUNCH, LIGHT_SCREEN, REFLECT
	db 42, TENTACRUEL, ICE_BEAM, SLUDGE_BOMB, SURF, BARRIER
	db 45, MAGNETON,   ZAP_CANNON, SUPERSONIC, SCREECH, LOCK_ON
	db -1 ; end
...
LassGroup:
	...
	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,    SURF, DISABLE, CONFUSION, SCREECH
	db 32, AMPHAROS,   TACKLE, GROWL, THUNDERPUNCH, THUNDER_WAVE
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 39, AMPHAROS,   FIRE_PUNCH, THUNDERPUNCH, THUNDER_WAVE, FLASH
	db 39, NINETALES,  FLAMETHROWER, CONFUSE_RAY, SWIFT, TAIL_WHIP
	db 39, GOLDUCK,    SURF, DISABLE, HEADBUTT, SCREECH
	db -1 ; end

	; LASS (17)
	db "DANA@", TRAINERTYPE_ITEM_MOVES
	db 44, AMPHAROS,   CHARCOAL,     FIRE_PUNCH, THUNDERBOLT, THUNDER_WAVE, LIGHT_SCREEN
	db 44, NINETALES,  PINK_BOW,     FLAMETHROWER, CONFUSE_RAY, SWIFT, TAIL_WHIP
	db 44, GOLDUCK,    TWISTEDSPOON, SURF, PSYCHIC_M, ICE_BEAM, DISABLE
	db -1 ; end
...
BeautyGroup:
	...
	db 20, NIDORINA,   SCRATCH, GROWL, DOUBLE_KICK, POISON_STING
	db -1 ; end
...
GruntMGroup:
	...
	db "EXECUTIVE@", TRAINERTYPE_MOVES
  	db 40, GOLBAT,     SCREECH, LEECH_LIFE, CONFUSE_RAY, WING_ATTACK
	db -1 ; end
...
SkierGroup:
	...
	db "ROXANNE@", TRAINERTYPE_MOVES
  	db 34, JYNX,       LOVELY_KISS, POWDER_SNOW, MEAN_LOOK, HEADBUTT
	db -1 ; end
...
FisherGroup:
	...
	db 27, KINGLER,    SURF, LEER, STOMP, AMNESIA
	db 30, GYARADOS,   SURF, BITE, DRAGON_RAGE, LEER, 
	db -1 ; end
...
SwimmerFGroup:
	...
	db 23, HORSEA,     FLAIL, SMOKESCREEN, LEER, OCTAZOOKA
...
BurglarGroup:
	...
	db 36, CHARMELEON, CUT, GROWL, SMOKESCREEN, FLAMETHROWER
	db 34, KOFFING,    TACKLE, SCREECH, SLUDGE, SMOKESCREEN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  HEADBUTT, MEDITATE, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
	...
	db 25, MACHOP,     LEER, FOCUS_ENERGY, KARATE_CHOP, FORESIGHT
	db 25, MACHOKE,    FOCUS_ENERGY, KARATE_CHOP, FORESIGHT, ROCK_SLIDE
	db -1 ; end
...
ExecutiveMGroup:
	; EXECUTIVEM (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 34, HOUNDOUR,   EMBER, ROAR, BITE, SMOG
	db 36, HYPNO,      THUNDERPUNCH, BARRIER, HYPNOSIS, DREAM_EATER
	db 37, ARIADOS,    PSYBEAM, LEECH_LIFE, NIGHT_SHADE, SCREECH
	db 37, HOUNDOOM,   FIRE_SPIN, PURSUIT, BITE, FLAMETHROWER
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 39, GOLBAT,     LEECH_LIFE, SCREECH, CONFUSE_RAY, WING_ATTACK
	db -1 ; end

	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 33, KOFFING,    SCREECH, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 34, RATICATE,   SCREECH, BITE, QUICK_ATTACK, HYPER_FANG
	db 35, GOLDUCK,    PSYBEAM, ICE_PUNCH, SURF, HYPNOSIS
	db 35, WEEZING,    SCREECH, EXPLOSION, SLUDGE, SMOKESCREEN
	db 34, NINETALES,  CONFUSE_RAY, FLAMETHROWER, TAIL_WHIP, QUICK_ATTACK
	db 33, KOFFING,    SCREECH, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db -1 ; end
...
PsychicGroup:
	...
	db 23, EXEGGCUTE,  HYPNOSIS, REFLECT, LEECH_SEED, CONFUSION
	db 22, SLOWPOKE,   CURSE, TACKLE, WATER_GUN, CONFUSION
	db -1 ; end
...
PicnickerGroup:
	...
	db 31, CLEFABLE,   DEFENSE_CURL, SING, DOUBLESLAP, ROLLOUT
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 38, ARBOK,      SCREECH, ACID, CRUNCH, GLARE
	db 38, VILEPLUME,  MOONLIGHT, PETAL_DANCE, STUN_SPORE, ACID
	db 38, MURKROW,    PECK, PURSUIT, HAZE, NIGHT_SHADE
	db -1 ; end

	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 29, ARBOK,      GLARE, LEER, POISON_STING, BITE
	db 29, GLOOM,      ABSORB, CUT, STUN_SPORE, ACID
	db 31, MURKROW,    WING_ATTACK, PURSUIT, HAZE, FAINT_ATTACK
	db -1 ; end
...
SageGroup:
	...
	db  8, BELLSPROUT, VINE_WHIP, GROWTH, FLASH, NO_MOVE
	db 10, HOOTHOOT,   PECK, TACKLE, FORESIGHT, FLASH
	db -1 ; end
...
BoarderGroup:
	...
	db 30, SWINUB,     TACKLE, POWDER_SNOW, ENDURE, TAKE_DOWN
	db 32, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, ICE_PUNCH
	db 30, SWINUB,     TACKLE, POWDER_SNOW, ENDURE, TAKE_DOWN
	db -1 ; end
...
PokefanMGroup:
	...
	db 15, RAICHU,     THUNDERSHOCK, TAIL_WHIP, QUICK_ATTACK, NO_MOVE
	db -1 ; end
...
TwinsGroup:
	...
	db 20, JIGGLYPUFF, SING, DEFENSE_CURL, DOUBLESLAP, DISABLE
	db -1 ; end
...
GruntFGroup:
	...
	db 30, ARBOK,      DIG, LEER, BITE, GLARE
	db 30, GLOOM,      ABSORB, ACID, STUN_SPORE, FLASH
	db -1 ; end
