...
; entries correspond to constants/move_constants.asm
	...
	move BIND,         EFFECT_TRAP_TARGET,        30, NORMAL,   PHYSICAL,  75, 20,   0
	...
	move WRAP,         EFFECT_TRAP_TARGET,        30, NORMAL,   PHYSICAL,  85, 20,   0
	...
	move SONICBOOM,    EFFECT_LEVEL_DAMAGE,        1, NORMAL,   SPECIAL,   90, 20,   0
	...
	move DRAGON_RAGE,  EFFECT_NORMAL_HIT,         80, DRAGON,   SPECIAL,  100, 10,   0
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        40, FIRE,     SPECIAL,   70, 15,   0
	...
	move NIGHT_SHADE,  EFFECT_NORMAL_HIT,         65, GHOST,    SPECIAL,  100, 15,   0
	...
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     30, NORMAL,   PHYSICAL, 100, 35,  10
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  20, GROUND,   PHYSICAL, 100, 10, 100
	...
	move EXTREMESPEED, EFFECT_PRIORITY_HIT,       90, NORMAL,   PHYSICAL, 100,  5,   0
	...
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        40, WATER,    SPECIAL,   70, 15,   0
